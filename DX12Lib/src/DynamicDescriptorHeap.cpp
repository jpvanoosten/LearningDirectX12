...
DynamicDescriptorHeap::DynamicDescriptorHeap( std::shared_ptr<Device> device, D3D12_DESCRIPTOR_HEAP_TYPE heapType,
...
void DynamicDescriptorHeap::ParseRootSignature( std::shared_ptr<RootSignature> rootSignature )
{
