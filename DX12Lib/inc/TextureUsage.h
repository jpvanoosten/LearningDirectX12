 ...
 * Diffuse (and albedo) textures should be loaded and store using sRGB formats
 ...
 * ignore any sRGB settings they may contain in the metadata of the image file.
 * 
 * The texture usage also determines how 
 */
#pragma once
